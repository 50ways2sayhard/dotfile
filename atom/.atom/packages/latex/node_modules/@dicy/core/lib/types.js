...
const CACHE_VERSION = exports.CACHE_VERSION = '0.10.0';

// START_AUTO

const DEFAULT_OPTIONS = exports.DEFAULT_OPTIONS = { $BIBINPUTS: ['$ROOTDIR', '$ROOTDIR/$OUTDIR', ''],
  $TEXINPUTS: ['$ROOTDIR', '$ROOTDIR/$OUTDIR', ''],
  bibtexEngine: 'bibtex',
  cleanPatterns: ['$OUTDIR/$JOB!($OUTEXT|.synctex.gz|.tex)', '/$OUTDIR/_minted-$JOB/*'],
