...
const customSetting_1 = require("../models/customSetting");
const extensionConfig_1 = require("../models/extensionConfig");
const localConfig_1 = require("../models/localConfig");
...
class Commons {
    ...
    InitalizeSettings(askToken, askGist) {
        return __awaiter(this, void 0, void 0, function* () {
            let me = this;
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                var settings = new localConfig_1.LocalConfig();
    ...
    GetCustomSettings() {
        return __awaiter(this, void 0, void 0, function* () {
            let me = this;
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                let customSettings = new customSetting_1.CustomSetting();
                try {
    ...
    StartMigrationProcess() {
        let me = this;
        let settingKeys = Object.keys(new extensionConfig_1.ExtensionConfig());
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (fileExist) {
                ...
                firstTime = true;
                customSettings = new customSetting_1.CustomSetting();
            }
    ...
    GetSettings() {
        var me = this;
        let settings = new extensionConfig_1.ExtensionConfig();
    ...
    GetAllFiles() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            contentFiles = yield fileManager_1.FileManager.ListFiles(this.en.USER_FOLDER, 0, 2);
