...
const storageService_1 = require("./common/storageService");
const testManagerServiceFactory_1 = require("./common/testManagerServiceFactory");
const testResultsService_1 = require("./common/testResultsService");
const testUtils_1 = require("./common/testUtils");
const types_1 = require("./common/types");
const workspaceTestManagerService_1 = require("./common/workspaceTestManagerService");
...
function activate(context, outputChannel, symboldProvider) {
    ...
    testCollectionStorage = new storageService_1.TestCollectionStorageService();
    const testResultsService = new testResultsService_1.TestResultsService();
    const testsHelper = new testUtils_1.TestsHelper();
    const debugLauncher = new debugLauncher_1.DebugLauncher();
    const testManagerServiceFactory = new testManagerServiceFactory_1.TestManagerServiceFactory(outChannel, testCollectionStorage, testResultsService, testsHelper, debugLauncher);
    workspaceTestManagerService = new workspaceTestManagerService_1.WorkspaceTestManagerService(outChannel, testManagerServiceFactory);
...
function getTestManager(displayTestNotConfiguredMessage, resource) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (displayTestNotConfiguredMessage) {
            yield configuration_1.displayTestFrameworkError(wkspace, outChannel);
        }
    });
}
let timeoutId;
...
function selectAndRunTestMethod(cmdSource, resource, debug) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        testDisplay = testDisplay ? testDisplay : new picker_1.TestDisplay(testCollectionStorage);
        const selectedTestFn = yield testDisplay.selectTestFunction(testManager.workspace.fsPath, tests);
        if (!selectedTestFn) {
            return;
        }
        // tslint:disable-next-line:prefer-type-cast
        yield runTestsImpl(cmdSource, testManager.workspace, { testFunction: [selectedTestFn.testFunction] }, debug);
    });
}
function selectAndRunTestFile(cmdSource) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tests = testCollectionStorage.getTests(testManager.workspace);
        testDisplay = testDisplay ? testDisplay : new picker_1.TestDisplay(testCollectionStorage);
        const selectedFile = yield testDisplay.selectTestFile(testManager.workspace.fsPath, tests);
        if (!selectedFile) {
            return;
        }
        // tslint:disable-next-line:prefer-type-cast
        yield runTestsImpl(cmdSource, testManager.workspace, { testFile: [selectedFile] });
    });
}
function runCurrentTestFile(cmdSource) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // tslint:disable-next-line:prefer-type-cast
        yield runTestsImpl(cmdSource, testManager.workspace, { testFile: [testFiles[0]] });
    });
}
...
function discoverTests(cmdSource, resource, ignoreCache, userInitiated) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (testManager && (testManager.status !== types_1.TestStatus.Discovering && testManager.status !== types_1.TestStatus.Running)) {
