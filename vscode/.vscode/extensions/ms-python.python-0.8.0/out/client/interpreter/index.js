...
const index_1 = require("./virtualEnvs/index");
const venv_1 = require("./virtualEnvs/venv");
const virtualEnv_1 = require("./virtualEnvs/virtualEnv");
class InterpreterManager {
    constructor() {
        this.disposables = [];
        const virtualEnvMgr = new index_1.VirtualEnvironmentManager([new venv_1.VEnv(), new virtualEnv_1.VirtualEnv()]);
        const statusBar = vscode_1.window.createStatusBarItem(vscode_1.StatusBarAlignment.Left);
        this.interpreterProvider = new locators_1.PythonInterpreterLocatorService(virtualEnvMgr);
