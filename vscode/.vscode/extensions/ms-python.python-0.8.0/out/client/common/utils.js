...
function arePathsSame(path1, path2) {
    path1 = exports.IS_WINDOWS ? path1.replace(/\//g, "\\") : path1;
    path2 = exports.IS_WINDOWS ? path2.replace(/\//g, "\\") : path2;
    return path1.toUpperCase() === path2.toUpperCase();
}
exports.arePathsSame = arePathsSame;
function areBasePathsSame(path1, path2) {
    path1 = exports.IS_WINDOWS ? path1.replace(/\//g, "\\") : path1;
    path2 = exports.IS_WINDOWS ? path2.replace(/\//g, "\\") : path2;
    return path.dirname(path1).toUpperCase() === path.dirname(path2).toUpperCase();
}
exports.areBasePathsSame = areBasePathsSame;
