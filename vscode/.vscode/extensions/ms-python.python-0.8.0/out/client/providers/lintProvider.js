...
const constants_2 = require("../jupyter/common/constants");
...
class LintProvider {
    ...
    lintOpenPythonFiles() {
        vscode_1.workspace.textDocuments.forEach(document => {
            if (document.languageId === constants_2.PythonLanguage.language) {
    ...
    onLintDocument(document, trigger) {
        ...
        const promises = this.linters
            ...
            telemetry_1.sendTelemetryWhenDone(constants_3.LINTING, promise, stopWatch, { tool: item.Id, hasCustomArgs, trigger, executableSpecified });
            return promise;
        });
