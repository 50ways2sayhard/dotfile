...
class Linter extends baseLinter.BaseLinter {
    constructor(outputChannel) {
        super('pydocstyle', installer_1.Product.pydocstyle, outputChannel);
    }
    ...
    run(commandLine, args, document, cwd, cancellation) {
        ...
        return new Promise((resolve, reject) => {
            utils_1.execPythonFile(document.uri, commandLine, args, this.getWorkspaceRootPath(document), true, null, cancellation).then(data => {
